...
function createNewMarker(map, lat, lng, name) {
  ...
  return marker;
    ...
    } else if(document.getElementById('data-inicio').value== "" ||
      document.getElementById('data-inicio').value.length < 1) {
      alert( "Preencha campo DATA DE INICIO corretamente!" );

    } else if(document.getElementById('data-termino').value== "" ||
    document.getElementById('data-termino').value.length < 1) {
    alert( "Preencha campo DATA DE TERMINO corretamente!" );
